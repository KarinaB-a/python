...
def read_format_csv(path, fields, sep = ','):
    ...
    Идентификатор_ученика_1, Фамилия_1, Имя_1, Отчество_1, Класс_1, Успеваемость_1, Итоговая оценка_1, Награждение_1_для_выпускника, Перевод_в_следующий_класс_или_выпуск_1
